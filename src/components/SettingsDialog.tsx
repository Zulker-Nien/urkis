    ...
    <>
      ...
      {open && (
        <div className="fixed inset-0 z-50 bg-zinc-950/80 backdrop-blur-lg flex items-center justify-center p-4 sm:p-6 animate-in fade-in duration-300">
          <div className="relative w-full max-w-lg bg-zinc-900 rounded-2xl overflow-hidden border border-brand/15 shadow-2xl shadow-black/60 flex flex-col">
            ...
            <div className="flex min-h-[380px]">
              ...
              >
                <TabsList className="flex-col w-44 shrink-0 items-stretch justify-start gap-1 rounded-none border-r border-white/5 bg-zinc-950/40 p-3">
                  <p className="px-2 pt-1 pb-2 text-[10px] uppercase tracking-widest text-slate-600 font-mono">
                    Themes
                  </p>
                  <TabsTrigger
                    value="theme"
                    className="justify-start gap-2.5 rounded-lg px-3 py-2 data-[state=active]:bg-zinc-900 data-[state=active]:text-brand"
                  >
