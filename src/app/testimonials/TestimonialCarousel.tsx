      ...
      <div className="relative max-w-6xl mx-auto px-6 pt-24 lg:pt-32">
        ...
        <Fade className="mt-14 lg:mt-20">
          <blockquote className="relative">
            <span className="absolute -top-14 -left-4 lg:-left-8 text-[10rem] lg:text-[14rem] leading-none font-serif text-brand/[0.08] select-none pointer-events-none">
              ”
            </span>
              ...
              <footer className="mt-8 flex items-center gap-4">
                ...
                <div>
                  ...
                  <div className="text-sm text-slate-500 font-light">
                    ...
                    <span className="text-brand">{featured.company}</span>
                  </div>
                </div>
              </footer>
            </div>
        ...
        <div className="grid md:grid-cols-2 gap-12 mt-16 pb-24 lg:gap-16 lg:mt-24">
          {rest.map((testimonial, index) => (
            <Fade key={index} y={20}>
              <blockquote className="border-l-2 border-brand/25 pl-6 lg:pl-8">
                ...
                <footer className="mt-6 flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-slate-500 font-light">
                      ...
                      <span className="text-brand">{testimonial.company}</span>
                    </div>
                  </div>
                </footer>
              </blockquote>
